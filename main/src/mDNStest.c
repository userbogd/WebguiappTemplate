...
#define EXAMPLE_MDNS_INSTANCE "ESP32 with mDNS"
#define EXAMPLE_BUTTON_GPIO   CONFIG_MDNS_BUTTON_GPIO
#define CONFIG_MDNS_HOSTNAME "WEBGUIAPP"
...
void mDNSstart(void)
{
    ...
    initialise_button();
    xTaskCreate(&mdns_example_task, "mdns_example_task", 4096, NULL, 5, NULL);
}
